...
namespace BeholderDemo
{
    ...
    {
        public static readonly string ClientId = "210263d3-d41d-4f8b-8404-bb6e9ff70a93";
        public static readonly string[] Scopes = new[] { "openid", "offline_access", "api://210263d3-d41d-4f8b-8404-bb6e9ff70a93/access_as_user" };
        public static readonly string ServiceUri = "https://demohealthcheckapi.azurewebsites.net";
